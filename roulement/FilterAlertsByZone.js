...
function handleDropdownAlertZoneByEquipement() {
  ...
  if(selectedValue!="Choose ..." ){
    ...
    function handleDropdownAlertZoneByEquipement2() {
      ...
      xhr1.open("GET", "https://script.google.com/macros/s/AKfycbyr56hUrrsr8ooOSgMa3AtcePdy_rBnQhY7fqyZjoqP3DjIrxG1Ysg6Zd4WFWSdbZLC/exec?func=RR&id=15", true);  // Replace with your API endpoint
      xhr1.send();
