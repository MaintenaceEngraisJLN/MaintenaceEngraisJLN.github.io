    ...
    function sendHttpRequest1(selectedValueL,selectedValueE) {
      ...
      xhr.open("GET", "https://script.google.com/macros/s/AKfycbzefFDcfX2c4Pe0ufUYDc7kcn-YP3DfQZTI7sa_VhFUQaoVwsd2v8EuG-s9Ga9ieuRB/exec?func=RP&id=4&ligne="+selectedValueL+"&equipement="+selectedValueE, true);  // Replace with your API endpoint
      xhr.send();
    };
    ...
    function sendHttpRequest2(selectedValueL,selectedValueE,selectedValueP) {
      ...
      xhr.open("GET", "https://script.google.com/macros/s/AKfycbwB0P6uuBumj1blHTIHfRxSE_Uv4QCJLhpo50vZikEcl4r0hcAIfu3BpV3hcbjXmiA0/exec?func=RH&id=5&ligne="+selectedValueL+"&equipement="+selectedValueE+"&point="+selectedValueP, true);  // Replace with your API endpoint
      xhr.send();
    };
...
//END OF PLOT CHART CODE
 ...
 //END OF PLOT CHART CODE
    ...
    function displayResponseForAlert(response,selectedValue) {
        ...
        var dropdownAlertTypeByEquipement = document.getElementById("valueSelectorTypeForAlert");
            dropdownAlertTypeByEquipement.disabled = false;
...
//PLOT MULTIPLE CURVES
    ...
    function sendHttpRequest21(selectedValueL,selectedValueP) {
      ...
      xhr.open("GET", "https://script.google.com/macros/s/AKfycbze1UWW8NYHkU1zjnCF5knl6CIj4JqX-8GEduWvpohTO65Yi-pYuW_D5gOZnT11n1YJ/exec?func=MultiPlot&id=16&ligne="+selectedValueL+"&point="+selectedValueP, true);  // Replace with your API endpoint
      xhr.send();
    };
