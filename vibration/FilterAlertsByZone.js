...
function handleDropdownAlertZoneByEquipement() {
  ...
  if(selectedValue!="Choose ..." ){
      ...
      dropdownAlertTypeByEquipement.disabled = true;
    ...
    function handleDropdownAlertZoneByEquipement1(response) {
      ...
      var selectedValue = '';
      for (var i = 0; i < dropdownAlertTypeByEquipement.options.length; i++) {
          if (dropdownAlertTypeByEquipement.options[i].selected) {
              selectedValue=dropdownAlertTypeByEquipement.options[i].value;
              i=dropdownAlertTypeByEquipement.options.length;
          }
      }
                            ...
                            for (var k=0; k<points.length;k++){
                              ...
                              if(entetToKeep[y]==points[k]+"_A"){
                                ...
                                if(equipementRecord[w] - seuilsA[k]>0) {
                                  ...
                                  tableHtml += "<td id='"+idStr+"' style=' text-align: center; vertical-align: middle; color : #fc0394; font-weight: bold; ' >";
                                  tableHtml += "";
                                  tableHtml += "</td>";
                                  ...
                                  tableHtml += "<td id='"+idStr+"' style='text-align: center; vertical-align: middle; ' >";
                                  tableHtml += "";
                                  tableHtml += "</td>";
                            ...
                            for (var k=0; k<points.length;k++){
                              if(entetToKeep[y]==points[k]+"_V"){
                                ...
                                if(equipementRecord[w] - seuilsV[k] > 0) {
                                  ...
                                  tableHtml += "<td id='"+idStr+"' style='text-align: center; vertical-align: middle; color: red; font-weight: bold; ' >";
                                  tableHtml += "" ;
                                  tableHtml += "</td>";
